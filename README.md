...
Aggregazione: Metodo Mazziotta-Pareto per la valutazione del grado di equità sistemica.<br>
Analisi avanzata: Confronto tra pesi arbitrari (uguali) e pesi determinati tramite PCA (Principal Component Analysis).<br>
📊 Key Insights<br>
